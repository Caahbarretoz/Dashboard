...
const SalesChart = () => {
  return (
    <div className="flex flex-col items-center w-[98%] h-full text-titles">
      <div className="flex w-full">
        <div>
          <h1 className="text-13 font-bold">Vendas hoje</h1>
          <h2 className="mt-1 text-[11px] text-zinc-400">Resumo de vendas</h2>
        </div>
        <button className="flex items-center h-8 ml-auto px-3 border-2 rounded-lg text-[10px] cursor-pointer hover:bg-dark-green hover:text-white hover:border-0">
          <BiExport /> Exportar
        </button>
      </div>
