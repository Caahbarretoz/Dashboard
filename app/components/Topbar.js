...
const Topbar = () => {
  return (
    <div className="flex items-center w-[100%] h-[100%] bg-black-custom text-titles">
      <h1 className="hidden lg:flex ml-7 text-2xl text-big-title font-bold">
        Dashboard
      </h1>
      ...
      <div className="flex items-center w-[100%] sm:ml-4 lg:ml-40 sm:space-x-10">
        <div className="flex items-center w-[50%] sm:w-[30%] lg:w-80 px-5 py-2.5 bg-black rounded-xl">
          <button
            type="submit"
            className=" text-xs sm:text-lg text-ciano-custom"
          >
            <IoSearch />
          </button>
          <input
        ...
        <div className="flex items-center ml-[25%] sm:ml-0 sm:space-x-4">
          <div className="flex items-center justify-center h-8 w-8 rounded-md text-orange-400 cursor-pointer">
            <TfiBell />
          </div>
